...
@section('title_header') Transaksi Warga @endsection
...
@section('content')
    <div class="d-flex flex-sm-column flex-md-row flex-lg-row justify-content-between my-3">
        <div>
            <h3>Transaksi Warga</h3>
        </div>
        <nav aria-label="breadcrumb" class="breadcrumb-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('citizen/transaction') }}">Iuran</a></li>
...
@section('extends-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            const url = `{{url('citizen/transaction/datatable')}}`;
