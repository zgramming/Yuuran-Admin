...
@section('content')
    <div class="d-flex flex-sm-column flex-md-row flex-lg-row justify-content-between my-3">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('dues/category') }}">Iuran</a></li>
                                ...
                                <div class="col-sm-12 col-md-6 mb-sm-3">
                                    <div class="d-flex flex-row justify-content-md-end justify-content-sm-start ">
                                        <div class="form-group">
                                            <div class="buttons">
                                                <a href="#" class="btn btn-success" onclick="openBox('{{url('dues/category/form_modal/0')}}')"><span class="btn-label"><i class="fa fa-plus"></i></span> Tambah</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table" style="width: 100%" id="table_datatable">
                                ...
                                <tr>
                                    ...
                                    <th style="min-width: 200px">Jumlah Iuran</th>
...
@section('extends-js')
    <script type="text/javascript">
        $(document).ready(function(){
            const url = `{{url('dues/category/datatable')}}`;
